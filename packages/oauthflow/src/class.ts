 ...
 * 
 * Source: https://spec.openapis.org/oas/latest#oauth-flow-object
 */
export class OAuthFlow<T extends OAuthFlowObjectType> extends BaseObject<T> {
   ...
   * 
   * Source: https://spec.openapis.org/oas/latest#fixed-fields-24
   */
  ...
  /**
   * Creates a copy of the instance with the authorizationUrl property added.
   * 
   * @template T, U
  ...
  /**
   * Creates a copy of the instance with the tokenUrl property added.
   * 
   * @template T, U
  ...
  /**
   * Creates a copy of the instance with the refreshUrl property added.
   * 
   * @template T, U
  ...
  /**
   * Creates a copy of the instance with the scope property added.
   * 
   * @template T, U, V, P
